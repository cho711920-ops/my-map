...
test("merge cache invalidation finishes before the response is rendered", () => {
  ...
  assert.match(html, /js\/unified-listings-v8\.js\?v=8\.1\.35-transaction-check-emphasis/);
  assert.match(html, /css\/unified-listings-v8\.css\?v=8\.1\.35-transaction-check-emphasis/);
});
