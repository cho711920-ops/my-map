...
assert.match(htmlSource, /js\/script\.js\?v=6\.5\.51-customer-match-map-fixes/);
assert.match(htmlSource, /js\/operations-center-v7\.js\?v=7\.20\.3-customer-save-fast-feedback/);
