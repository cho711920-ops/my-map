...
assert.match(htmlSource, /js\/script\.js\?v=6\.5\.47-contact-speed-text-actions/);
assert.match(htmlSource, /js\/operations-center-v7\.js\?v=7\.18\.8-compact-map-status/);
