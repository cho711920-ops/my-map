...
assert.match(map, /getTransactionCheckClusterClassV8135/);
assert.match(map, /transaction-check-cluster-v8135/);
assert.match(unifiedCss, /#list \.item:has\(\.transaction-check-button-v8135\)/);
assert.match(unifiedCss, /circle-marker\.transaction-check-cluster-v8135/);
