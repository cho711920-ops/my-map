...
assert.match(html, /unified-favorites-v7\.css\?v=7\.0\.12-map-detail-list/);
assert.match(html, /unified-favorites-v7\.js\?v=7\.0\.12-map-detail-list/);
...
assert.match(favorites, /Math\.min\(1360, Math\.max\(920, global\.innerWidth - 48\)\)/);
...
assert.match(favorites, /unifiedFavoriteMapHostV7/);
assert.match(favorites, /unifiedFavoriteMiniMapV7/);
assert.match(favorites, /renderFavoriteLocationMapV7\(item\)/);
assert.match(favorites, /new global\.kakao\.maps\.Circle/);
assert.match(favorites, /radius: 50/);
assert.match(favorites, /item\.unifiedOriginalsV8\.some/);
...
assert.match(favoritesCss, /max-width:1360px;min-height:500px/);
...
assert.match(favoritesCss, /grid-template-columns:minmax\(220px,\.72fr\) minmax\(360px,1\.18fr\) minmax\(320px,1fr\)/);
assert.match(favoritesCss, /\.unified-favorite-map-host-v7\{/);
assert.match(favoritesCss, /\.unified-favorite-mini-map-v7\{/);
