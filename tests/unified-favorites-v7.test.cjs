...
assert.match(html, /unified-favorites-v7\.css\?v=7\.0\.1-create-layout/);
assert.match(html, /unified-favorites-v7\.js\?v=7\.0\.1-create-layout/);
assert.match(html, /list-manager-v6\.js\?v=6\.4\.28-favorite-store-events/);
...
assert.match(favorites, /event\.isComposing/);
